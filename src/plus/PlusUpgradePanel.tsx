...
const UPGRADE_COPY = {
  en: {
    ...
    plus: {
      ...
      button: "Plus subscriptions coming soon",
      footer:
        "Pricing and store subscriptions will be added before launch.",
    },
  },
  ...
  es: {
    ...
    plus: {
      ...
      button:
        "Suscripciones de Plus próximamente",
      footer:
        "Los precios y las suscripciones de las tiendas se añadirán antes del lanzamiento.",
    },
  },
} as const;
    ...
    <section className="sd-plus-upgrade">
      ...
      <div className="sd-plus-plan-grid">
        ...
        <article className="sd-plus-plan-card is-plus">
          ...
          <button
            type="button"
            className="sd-plus-coming-soon-button"
            disabled
          >
            {copy.plus.button}
          </button>
